        ...
        public static async Task SeedAsync(BookDbContext context)
        {
            ...
            if (!context.Customers.Any())
            {
                var customers = new List<Customer>
                {
                    ...
                    new Customer { FullName = "Mahmoud Tarek", Email = "mahmoud@test.com", PhoneNumber = "01500000004" },
                    new Customer { FullName = "Nourhan Youssef", Email = "nourhan@test.com", PhoneNumber = "01111111111" },
                    new Customer { FullName = "No Purchase Customer", Email = "nopurchase@test.com", PhoneNumber = "01200000003" }
                };
            ...
            if (!context.Orders.Any())
            {
                var orders = new List<Order>
                {
                    ...
                    new Order
                    {
                        CustomerId = 3, OrderDate = new DateTime(2026, 3, 22), TotalAmount = 750,
                        OrderItems = new List<OrderItem>
                        {
                            new OrderItem { BookId = 1, Quantity = 5, UnitPriceAtPurchase = 150 }
                        }
                    },
                    new Order
                    {
                        CustomerId = 4, OrderDate = new DateTime(2026, 4, 5), TotalAmount = 620,
                        OrderItems = new List<OrderItem>
                        {
                            new OrderItem { BookId = 4, Quantity = 2, UnitPriceAtPurchase = 180 },
                            new OrderItem { BookId = 7, Quantity = 1, UnitPriceAtPurchase = 260 } 
                        }
                    },
                    new Order
                    {
                        CustomerId = 1, OrderDate = new DateTime(2026, 5, 28), TotalAmount = 280,
                        OrderItems = new List<OrderItem>
                        {
                            new OrderItem { BookId = 6, Quantity = 2, UnitPriceAtPurchase = 140 }
                        }
                    }
                };
